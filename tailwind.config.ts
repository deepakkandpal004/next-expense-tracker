  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'display-hero': ['clamp(2.5rem, 5vw, 4.5rem)', { lineHeight: '1.1', letterSpacing: '-0.04em', fontWeight: '800' }],
        'display-xl': ['clamp(2rem, 3.5vw, 3.5rem)', { lineHeight: '1.15', letterSpacing: '-0.03em', fontWeight: '700' }],
        'display-2xl': ['clamp(1.75rem, 3vw, 2.5rem)', { lineHeight: '1.2', letterSpacing: '-0.025em', fontWeight: '700' }],
        'display-3xl': ['clamp(1.5rem, 2.5vw, 2rem)', { lineHeight: '1.25', letterSpacing: '-0.02em', fontWeight: '700' }],
        'display-4xl': ['clamp(1.25rem, 2vw, 1.5rem)', { lineHeight: '1.3', letterSpacing: '-0.02em', fontWeight: '600' }],
        lead: ['var(--font-size-lead)', { lineHeight: 'var(--line-height-lead)', fontWeight: '500' }],
        body: ['var(--font-size-body)', { lineHeight: 'var(--line-height-body)', fontWeight: '500' }],
        label: ['var(--font-size-label)', { lineHeight: 'var(--line-height-label)', fontWeight: '500', letterSpacing: '0.01em' }],
        caption: ['0.8125rem', { lineHeight: '1.25rem', fontWeight: '500', letterSpacing: '0.01em' }],
        'caption-strong': ['0.8125rem', { lineHeight: '1.25rem', fontWeight: '600', letterSpacing: '0.01em' }],
      },
      maxWidth: {
