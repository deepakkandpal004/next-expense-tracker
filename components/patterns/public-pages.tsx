...
function CapabilityGrid() {
  return <div className={gridClass}>{capabilities.map(([title, description]) => <Card as='article' key={title}><h3 className='text-interface-md font-semibold'>{title}</h3><p className='mt-2 text-interface-sm text-foreground-secondary'>{description}</p></Card>)}</div>;
}
