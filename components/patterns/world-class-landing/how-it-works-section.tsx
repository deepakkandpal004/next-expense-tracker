      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 sm:px-8">
        <div className="text-center">
          <AnimateInView>
            ...
            <p className="mx-auto mt-5 max-w-3xl text-lg leading-relaxed text-[#9AA3AF]">
            ...
            {workflowSteps.map((step, index) => (
              <AnimateInView key={step.number} delay={index * 0.1}>
                <motion.div
                  ...
                  className="group relative flex h-full flex-col items-center gap-3 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5 text-center transition-all duration-300 hover:border-[#00DCE5]/20 hover:bg-[#00DCE5]/[0.04]"
                >
